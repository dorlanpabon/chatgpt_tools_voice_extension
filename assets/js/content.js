(() => {
    ...
    let i18n = {
        "es": {
            ...
            "TextoCopiado": "Texto copiado al portapapeles",
            "ProcesandoParaLeer": "Procesando para leer",
        },
        "en": {
            ...
            "ProcesandoParaLeer": "Processing to read",
        }
    };
    ...
    toast.id = "toast";
    toast.style.cssText = "position: fixed; bottom: 0; left: 0; right: 0; padding: 10px; background-color: #10a37f; color: white; font-size: 16px; text-align: center; display: none;";
    ...
    setInterval(function () {
        ...
        elements.forEach(function (element) {
            ...
            button1.onclick = function () {
                ...
                // Agregar el "toast" al final del cuerpo de la página
            ...
            button2.onclick = function () {
                ...
                // Agregar el "toast" al final del cuerpo de la página
                document.body.appendChild(toast);
                toast.textContent = i18n[lang]["TextoCopiado"];
                // Mostrar el "toast" durante 3 segundos y luego eliminarlo
                toast.style.display = "block";
                console.log(toast);
                setTimeout(() => {
