(() => {
    ...
    toast.id = "toast";
    toast.style.cssText = "position: fixed; bottom: 0; left: 0; right: 0; padding: 10px; background-color: #202123; color: white; font-size: 16px; text-align: center; display: none;";
    ...
    setInterval(function () {
        ...
        elements.forEach(function (element) {
            ...
            button2.onclick = function () {
                ...
                // Mostrar el "toast" durante 5 segundos y luego eliminarlo
